...
import { ChevronDown, MapPin, UserRound, Globe, Search } from "lucide-react";
        ...
        <div className="min-h-screen flex justify-center bg-black">
            <div className="max-w-md w-full px-4 pt-4 bg-white flex flex-col gap-4 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0  w-40 h-36">
                    <svg className="" width={160} height={146} viewBox=" 0 0 160 146">
                        <motion.path d="M 10,0 L 30,60 L 80,35 L 100,120 L 120,40 L 160,70" 
                            stroke="#FEE8ED" 
                            strokeWidth={15} 
                    ...
                    <div className="w-[60%] flex flex-col gap-1 justify-center relative">
                        ...
                        <div className="flex items-center justify-center p-1 bg-[#F4F4F6] rounded-full h-fit w-fit ">
                            <svg width="18" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.6673 7.33329C13.6673 11.4941 9.05148 15.8275 7.50148 17.1658C7.35709 17.2744 7.18132 17.3331 7.00065 17.3331C6.81999 17.3331 6.64421 17.2744 6.49982 17.1658C4.94982 15.8275 0.333984 11.4941 0.333984 7.33329C0.333984 5.56518 1.03636 3.86949 2.28661 2.61925C3.53685 1.36901 5.23254 0.666626 7.00065 0.666626C8.76876 0.666626 10.4645 1.36901 11.7147 2.61925C12.9649 3.86949 13.6673 5.56518 13.6673 7.33329Z" fill="#8E64B3"/>
                                <path d="M7 9.83337C8.38071 9.83337 9.5 8.71409 9.5 7.33337C9.5 5.95266 8.38071 4.83337 7 4.83337C5.61929 4.83337 4.5 5.95266 4.5 7.33337C4.5 8.71409 5.61929 9.83337 7 9.83337Z" fill="white"/>
                            </svg>
                ...
                {/* Questions part */}
                <h1 className="font-semibold text-3xl w-[65%]">
                ...
                <div className="w-full rounded-xl py-3 px-2 bg-[#F4F4F6] relative">
                    <input type="text" 
                        ...
                        className=" w-full rouned-xl pl-4 focus:outline-none"
                        value={searchQuery}
                ...
                {/* Category */}
                    ...
                    <div className="flex overflow-x-scroll gap-2 scrollbar-hide">
                        {categories.map((cat)=>(
                            <motion.div className={`flex gap-1 w-fit h-fit p-2 rounded-2xl cursor-pointer transition-all duration-200 ${
    selectedCategory === cat.id ? "bg-black text-white" : "bg-white text-black"}`} key={cat.id}
                            ...
                            >
                                <div className="rounded-full relative w-6 h-6">
                                    <Image src={"/placeholder.jpg"} alt="placeeholder" fill className="object-cover rounded-full"/>
                                </div>
