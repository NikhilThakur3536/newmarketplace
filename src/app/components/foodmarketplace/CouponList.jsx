        ...
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              initial={{ opacity: 0, x: -50, textPath:0}}
              animate={{ opacity: 1, x: 0, textPath:1 }}
              exit={{ opacity: 0, x: -50 }}
            ...
            >
              ...
              <h3 className="text-2xl font-semibold">{currentCoupon.discountAmount}%</h3>
          ...
          >
            <Image src="/discountPlaceholder.png" alt="image" className="object-cover" fill />
          </motion.div>
        </motion.div>
      </AnimatePresence>
      {/* Navigation Buttons */}
